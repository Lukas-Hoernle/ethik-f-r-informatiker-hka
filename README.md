...
> "Der EU AI Act zielt darauf ab, einheitliche Standards für die Entwicklung und Nutzung von KI in der EU zu etablieren. Er soll KI-Systeme vertrauenswürdig und menschenzentriert machen, Innovationen fördern und grenzüberschreitende Anwendungen ermöglichen." (M. Schaub, "The EU AI Act: A Model for Global AI Regulation?")
...
> "Ohne klare Regeln könnten KI-Systeme Risiken für Grundrechte darstellen, insbesondere im Hinblick auf Datenschutz und Sicherheit." (J. Scott Marcus, "The European Union's Proposed AI Act: An Overview")
...
> "Der EU AI Act verfolgt mehrere Ziele, darunter die Förderung sicherer, transparenter und ethischer KI-Systeme sowie die Wahrung der Grundrechte, insbesondere Datenschutz und Nichtdiskriminierung." (B. van der Sloot, "The EU AI Act: A First Step Towards a Global AI Regulatory Framework?")
...
> "Unannehmbare Risiken, wie Verhaltensbeeinflussung ohne Wissen der Betroffenen und Social Scoring, sind verboten." (M. Schaub, "The EU AI Act: A Model for Global AI Regulation?")
...
> "Hohe Risiken, wie KI-Anwendungen in kritischer Infrastruktur, Gesundheitswesen, Strafverfolgung und Bildung, unterliegen strengen Anforderungen, darunter Risikomanagement, Datenqualitätskontrollen und technische Dokumentationen." (J. Scott Marcus, "The European Union's Proposed AI Act: An Overview")
...
> "KI-Systeme mit begrenztem Risiko, wie Chatbots und Deepfake-Technologien, unterliegen weniger strengen Vorschriften, um das Vertrauen der Nutzer zu stärken und negative Auswirkungen zu minimieren." (B. van der Sloot, "The EU AI Act: A First Step Towards a Global AI Regulatory Framework?")
...
> "Für geringe Risiken, wie Spamfilter oder personalisierte Werbung, gelten keine speziellen Regeln im Act, um Entwicklern größere Freiheiten zu lassen." (M. Schaub, "The EU AI Act: A Model for Global AI Regulation?")
...
> "Allzweck-KI-Systeme, wie große Sprachmodelle, unterliegen speziellen Anforderungen und einer flexiblen Überwachung." (J. Scott Marcus, "The European Union's Proposed AI Act: An Overview")
...
> "Ausschüsse und Aufsichtsbehörden, wie der Europäische Ausschuss für KI und nationale Behörden, überwachen und setzen die Vorschriften durch." (B. van der Sloot, "The EU AI Act: A First Step Towards a Global AI Regulatory Framework?")
...
> "Eine Datenbank für Hochrisiko-KI-Systeme erhöht die Transparenz und Nachvollziehbarkeit der eingesetzten KI-Systeme." (M. Schaub, "The EU AI Act: A Model for Global AI Regulation?")
...
> "Die strengen technischen Anforderungen des EU AI Acts stellen eine Herausforderung für Unternehmen dar." (J. Scott Marcus, "The European Union's Proposed AI Act: An Overview")
...
> "Strenge Regelungen und Prüfverfahren könnten die Innovationskraft von Unternehmen beeinträchtigen." (B. van der Sloot, "The EU AI Act: A First Step Towards a Global AI Regulatory Framework?")
...
> "Der EU AI Act fordert strenge Datenschutzmaßnahmen und die Berücksichtigung ethischer Fragen." (M. Schaub, "The EU AI Act: A Model for Global AI Regulation?")
...
> "Der EU AI Act kann Vertrauen und Akzeptanz für KI-Technologien in der Gesellschaft schaffen." (B. van der Sloot, "The EU AI Act: A First Step Towards a Global AI Regulatory Framework?")
...
> "Der EU AI Act könnte als Katalysator für Innovation und Forschung dienen." (J. Scott Marcus, "The European Union's Proposed AI Act: An Overview")
...
> "Die Einhaltung hoher Standards in Bezug auf Qualität und Sicherheit kann Unternehmen einen Wettbewerbsvorteil verschaffen." (M. Schaub, "The EU AI Act: A Model for Global AI Regulation?")
...
> "Der EU AI Act fördert eine nachhaltige Entwicklung und soziale Verantwortung." (B. van der Sloot, "The EU AI Act: A First Step Towards a Global AI Regulatory Framework?")
...
> "Langfristig könnte der EU AI Act die europäische KI-Landschaft positiv beeinflussen." (J. Scott Marcus, "The European Union's Proposed AI Act: An Overview")
...
> "Anbieter von Hochrisiko-KI-Systemen müssen umfassende Risikobewertungen durchführen und Maßnahmen zur Risikominderung implementieren." (B. van der Sloot, "The EU AI Act: A First Step Towards a Global AI Regulatory Framework?")
...
> "Anbieter von Hochrisiko-KI-Systemen müssen technische Dokumentationen erstellen und eine Konformitätsbewertung durchführen." (M. Schaub, "The EU AI Act: A Model for Global AI Regulation?")
...
> "Anbieter von Hochrisiko-KI-Systemen müssen sicherstellen, dass Nutzer über die Funktionsweise und mögliche Risiken informiert sind." (J. Scott Marcus, "The European Union's Proposed AI Act: An Overview")
...
> "Anbieter von Hochrisiko-KI-Systemen müssen ihre Systeme kontinuierlich überwachen und regelmäßig Berichte erstellen." (B. van der Sloot, "The EU AI Act: A First Step Towards a Global AI Regulatory Framework?")
...
> "Die Transparenzanforderungen des EU AI Acts stellen sicher, dass die Funktionsweise und Entscheidungsprozesse von Hochrisiko-KI-Systemen für Nutzer nachvollziehbar sind." (M. Schaub, "The EU AI Act: A Model for Global AI Regulation?")
...
> "Die Sicherheitsanforderungen des EU AI Acts zielen darauf ab, die Integrität und Zuverlässigkeit von Hochrisiko-KI-Systemen zu gewährleisten." (J. Scott Marcus, "The European Union's Proposed AI Act: An Overview")
...
> "Der EU AI Act fordert, dass die in Hochrisiko-KI-Systemen verwendeten Daten genau, vollständig und repräsentativ sind." (B. van der Sloot, "The EU AI Act: A First Step Towards a Global AI Regulatory Framework?")
...
> "Anbieter von Hochrisiko-KI-Systemen müssen sicherstellen, dass ihre Systeme in Übereinstimmung mit ethischen und rechtlichen Standards betrieben werden." (M. Schaub, "The EU AI Act: A Model for Global AI Regulation?")
...
> "Die Regelungen des EU AI Acts für Hochrisiko-KI-Systeme sind umfassend und detailliert." (J. Scott Marcus, "The European Union's Proposed AI Act: An Overview")
...
> "Langfristig könnten die Regelungen des EU AI Acts dazu beitragen, eine sichere und verantwortungsvolle Nutzung von KI-Technologien in der EU zu fördern." (B. van der Sloot, "The EU AI Act: A First Step Towards a Global AI Regulatory Framework?")
...
> "Die nationalen Aufsichtsbehörden sind für die Überwachung und Durchsetzung des EU AI Act in den jeweiligen Mitgliedstaaten verantwortlich." (M. Schaub, "The EU AI Act: A Model for Global AI Regulation?")
...
> "Auf europäischer Ebene gibt es spezialisierte Aufsichtsbehörden, die die Einhaltung des EU AI Act überwachen." (B. van der Sloot, "The EU AI Act: A First Step Towards a Global AI Regulatory Framework?")
...
> "Ein wichtiger Aspekt der Überwachung und Durchsetzung ist die Zusammenarbeit und der Austausch von Informationen zwischen den verschiedenen Aufsichtsbehörden." (J. Scott Marcus, "The European Union's Proposed AI Act: An Overview")
...
> "Ein zentraler Durchsetzungsmechanismus sind Inspektionen und Audits." (B. van der Sloot, "The EU AI Act: A First Step Towards a Global AI Regulatory Framework?")
...
> "Bei Verstößen gegen den EU AI Act können die Aufsichtsbehörden Sanktionen und Strafen verhängen." (M. Schaub, "The EU AI Act: A Model for Global AI Regulation?")
...
> "Bürger und Unternehmen haben die Möglichkeit, Beschwerden über mutmaßliche Verstöße gegen den Act einzureichen." (J. Scott Marcus, "The European Union's Proposed AI Act: An Overview")
...
> "Ein weiterer wichtiger Durchsetzungsmechanismus ist die Schulung und Sensibilisierung von Unternehmen und der Öffentlichkeit." (B. van der Sloot, "The EU AI Act: A First Step Towards a Global AI Regulatory Framework?")
...
> "Die Überwachung und Durchsetzung des EU AI Act sind entscheidend für die Einhaltung der Vorschriften und die Gewährleistung von Sicherheit und Transparenz." (M. Schaub, "The EU AI Act: A Model for Global AI Regulation?")
...
> "Langfristig könnte die effektive Überwachung und Durchsetzung des EU AI Act dazu beitragen, eine sichere und verantwortungsvolle Nutzung von KI-Technologien in der EU zu fördern." (B. van der Sloot, "The EU AI Act: A First Step Towards a Global AI Regulatory Framework?")
...
> "Um mit den technologischen Fortschritten Schritt zu halten, muss der EU AI Act flexibel und anpassungsfähig sein." (J. Scott Marcus, "The European Union's Proposed AI Act: An Overview")
...
> "Strenge Regulierungen sind zwar wichtig für die Sicherheit, dürfen aber nicht die Innovationskraft der europäischen Wirtschaft hemmen." (B. van der Sloot, "The EU AI Act: A First Step Towards a Global AI Regulatory Framework?")
...
> "Eine langfristige Planung ist notwendig, um Entwicklungen im Bereich KI vorherzusehen und entsprechend zu reagieren." (M. Schaub, "The EU AI Act: A Model for Global AI Regulation?")
...
> "Die internationale Zusammenarbeit ist von entscheidender Bedeutung für die erfolgreiche Regulierung von KI." (B. van der Sloot, "The EU AI Act: A First Step Towards a Global AI Regulatory Framework?")
...
> "Bilaterale und multilaterale Abkommen zwischen der EU und anderen Ländern können den Austausch von Wissen und Best Practices erleichtern." (J. Scott Marcus, "The European Union's Proposed AI Act: An Overview")
...
> "Die EU sollte eng mit internationalen Organisationen wie den Vereinten Nationen, der Internationalen Organisation für Normung (ISO) und der OECD zusammenarbeiten." (M. Schaub, "The EU AI Act: A Model for Global AI Regulation?")
...
> "Eine der größten Herausforderungen bei der Regulierung von KI ist die technologische Komplexität." (B. van der Sloot, "The EU AI Act: A First Step Towards a Global AI Regulatory Framework?")
...
> "Ethische Fragen spielen eine zentrale Rolle bei der Regulierung von KI." (J. Scott Marcus, "The European Union's Proposed AI Act: An Overview")
...
> "Die Zukunft der KI ist dynamisch und von schnellen Veränderungen geprägt." (M. Schaub, "The EU AI Act: A Model for Global AI Regulation?")
...
> "Der EU AI Act schafft einen klaren und einheitlichen Rechtsrahmen, der die Sicherheit und Transparenz von KI-Systemen gewährleistet." (B. van der Sloot, "The EU AI Act: A First Step Towards a Global AI Regulatory Framework?")
