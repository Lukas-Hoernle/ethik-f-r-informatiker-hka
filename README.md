...
> "Der EU AI Act zielt darauf ab, einheitliche Standards für die Entwicklung und Nutzung von KI in der EU zu etablieren. Er soll KI-Systeme vertrauenswürdig und menschenzentriert machen, Innovationen fördern und grenzüberschreitende Anwendungen ermöglichen." (Quelle: eigene Darstellung)
...
> "Der EU AI Act soll die Risiken minimieren und Grundrechte, insbesondere Datenschutz und Sicherheit, schützen." (Quelle: eigene Darstellung)
...
> "Der EU AI Act verfolgt mehrere Ziele, darunter die Förderung sicherer, transparenter und ethischer KI-Systeme sowie die Wahrung der Grundrechte, insbesondere Datenschutz und Nichtdiskriminierung." (Quelle: eigene Darstellung)
...
> "Der EU AI Act verbietet unannehmbare Risiken, wie Verhaltensbeeinflussung ohne Wissen der Betroffenen und Social Scoring." (Quelle: eigene Darstellung)
...
> "Hohe Risiken, wie KI-Anwendungen in kritischer Infrastruktur, Gesundheitswesen, Strafverfolgung und Bildung, unterliegen strengen Anforderungen, darunter Risikomanagement, Datenqualitätskontrollen und technische Dokumentationen." (Quelle: eigene Darstellung)
...
> "KI-Systeme mit begrenztem Risiko, wie Chatbots und Deepfake-Technologien, unterliegen weniger strengen Vorschriften, um das Vertrauen der Nutzer zu stärken und negative Auswirkungen zu minimieren." (Quelle: eigene Darstellung)
...
> "Für geringe Risiken, wie Spamfilter oder personalisierte Werbung, gelten keine speziellen Regeln im Act, um Entwicklern größere Freiheiten zu lassen." (Quelle: eigene Darstellung)
...
> "Allzweck-KI-Systeme, wie große Sprachmodelle, unterliegen speziellen Anforderungen und einer flexiblen Überwachung." (Quelle: eigene Darstellung)
...
> "Ausschüsse und Aufsichtsbehörden, wie der Europäische Ausschuss für KI und nationale Behörden, überwachen und setzen die Vorschriften durch." (Quelle: eigene Darstellung)
...
> "Eine Datenbank für Hochrisiko-KI-Systeme erhöht die Transparenz und Nachvollziehbarkeit der eingesetzten KI-Systeme." (Quelle: eigene Darstellung)
...
> "Die strengen technischen Anforderungen des EU AI Acts stellen eine Herausforderung für Unternehmen dar." (Quelle: eigene Darstellung)
...
> "Strenge Regelungen und Prüfverfahren könnten die Innovationskraft von Unternehmen beeinträchtigen." (Quelle: eigene Darstellung)
...
> "Der EU AI Act fordert strenge Datenschutzmaßnahmen und die Berücksichtigung ethischer Fragen." (Quelle: eigene Darstellung)
...
> "Der EU AI Act kann Vertrauen und Akzeptanz für KI-Technologien in der Gesellschaft schaffen." (Quelle: eigene Darstellung)
...
> "Der EU AI Act könnte als Katalysator für Innovation und Forschung dienen." (Quelle: eigene Darstellung)
...
> "Die Einhaltung hoher Standards in Bezug auf Qualität und Sicherheit kann Unternehmen einen Wettbewerbsvorteil verschaffen." (Quelle: eigene Darstellung)
...
> "Der EU AI Act fördert eine nachhaltige Entwicklung und soziale Verantwortung." (Quelle: eigene Darstellung)
...
> "Langfristig könnte der EU AI Act die europäische KI-Landschaft positiv beeinflussen." (Quelle: eigene Darstellung)
...
> "Anbieter von Hochrisiko-KI-Systemen müssen umfassende Risikobewertungen durchführen und Maßnahmen zur Risikominderung implementieren." (Quelle: eigene Darstellung)

#### 4.1.2 Technische Dokumentation und Konformitätsbewertung

Eine weitere wichtige Verpflichtung ist die Erstellung und Pflege technischer Dokumentationen. Diese müssen alle relevanten Informationen über das KI-System enthalten, einschließlich Entwicklung, Funktionsweise und Sicherheitsmerkmale. Anbieter müssen zudem eine Konformitätsbewertung durchführen, um die Übereinstimmung ihres Systems mit den festgelegten Anforderungen zu bestätigen. Diese Bewertung kann von internen oder externen Prüfern durchgeführt werden.

> "Anbieter von Hochrisiko-KI-Systemen müssen technische Dokumentationen erstellen und eine Konformitätsbewertung durchführen." (Quelle: eigene Darstellung)
...
> "Anbieter von Hochrisiko-KI-Systemen müssen sicherstellen, dass Nutzer über die Funktionsweise und mögliche Risiken informiert sind." (Quelle: eigene Darstellung)
...
> "Anbieter von Hochrisiko-KI-Systemen müssen ihre Systeme kontinuierlich überwachen und regelmäßig Berichte erstellen." (Quelle: eigene Darstellung)
...
> "Die Transparenzanforderungen des EU AI Acts stellen sicher, dass die Funktionsweise und Entscheidungsprozesse von Hochrisiko-KI-Systemen für Nutzer nachvollziehbar sind." (Quelle: eigene Darstellung)
...
> "Die Sicherheitsanforderungen des EU AI Acts zielen darauf ab, die Integrität und Zuverlässigkeit von Hochrisiko-KI-Systemen zu gewährleisten." (Quelle: eigene Darstellung)
...
> "Der EU AI Act fordert, dass die in Hochrisiko-KI-Systemen verwendeten Daten genau, vollständig und repräsentativ sind." (Quelle: eigene Darstellung)
...
> "Anbieter von Hochrisiko-KI-Systemen müssen sicherstellen, dass ihre Systeme in Übereinstimmung mit ethischen und rechtlichen Standards betrieben werden." (Quelle: eigene Darstellung)
...
> "Die Regelungen des EU AI Acts für Hochrisiko-KI-Systeme sind umfassend und detailliert." (Quelle: eigene Darstellung)
...
> "Langfristig könnten die Regelungen des EU AI Acts dazu beitragen, eine sichere und verantwortungsvolle Nutzung von KI-Technologien in der EU zu fördern." (Quelle: eigene Darstellung)
...
> "Die nationalen Aufsichtsbehörden sind für die Überwachung und Durchsetzung des EU AI Act in den jeweiligen Mitgliedstaaten verantwortlich." (Quelle: eigene Darstellung)
...
> "Auf europäischer Ebene gibt es spezialisierte Aufsichtsbehörden, die die Einhaltung des EU AI Act überwachen." (Quelle: eigene Darstellung)
...
> "Ein wichtiger Aspekt der Überwachung und Durchsetzung ist die Zusammenarbeit und der Austausch von Informationen zwischen den verschiedenen Aufsichtsbehörden." (Quelle: eigene Darstellung)
...
> "Ein zentraler Durchsetzungsmechanismus sind Inspektionen und Audits." (Quelle: eigene Darstellung)
...
> "Bei Verstößen gegen den EU AI Act können die Aufsichtsbehörden Sanktionen und Strafen verhängen." (Quelle: eigene Darstellung)
...
> "Bürger und Unternehmen haben die Möglichkeit, Beschwerden über mutmaßliche Verstöße gegen den Act einzureichen." (Quelle: eigene Darstellung)
...
> "Ein weiterer wichtiger Durchsetzungsmechanismus ist die Schulung und Sensibilisierung von Unternehmen und der Öffentlichkeit." (Quelle: eigene Darstellung)
...
> "Die Überwachung und Durchsetzung des EU AI Act sind entscheidend für die Einhaltung der Vorschriften und die Gewährleistung von Sicherheit und Transparenz." (Quelle: eigene Darstellung)
...
> "Langfristig könnte die effektive Überwachung und Durchsetzung des EU AI Act dazu beitragen, eine sichere und verantwortungsvolle Nutzung von KI-Technologien in der EU zu fördern." (Quelle: eigene Darstellung)
...
> "Um mit den technologischen Fortschritten Schritt zu halten, muss der EU AI Act flexibel und anpassungsfähig sein." (Quelle: eigene Darstellung)
...
> "Strenge Regulierungen sind zwar wichtig für die Sicherheit, dürfen aber nicht die Innovationskraft der europäischen Wirtschaft hemmen." (Quelle: eigene Darstellung)
...
> "Eine langfristige Planung ist notwendig, um Entwicklungen im Bereich KI vorherzusehen und entsprechend zu reagieren." (Quelle: eigene Darstellung)
...
> "Die internationale Zusammenarbeit ist von entscheidender Bedeutung für die erfolgreiche Regulierung von KI." (Quelle: eigene Darstellung)
...
> "Bilaterale und multilaterale Abkommen zwischen der EU und anderen Ländern können den Austausch von Wissen und Best Practices erleichtern." (Quelle: eigene Darstellung)
...
> "Die EU sollte eng mit internationalen Organisationen wie den Vereinten Nationen, der Internationalen Organisation für Normung (ISO) und der OECD zusammenarbeiten." (Quelle: eigene Darstellung)
...
> "Eine der größten Herausforderungen bei der Regulierung von KI ist die technologische Komplexität." (Quelle: eigene Darstellung)
...
> "Ethische Fragen spielen eine zentrale Rolle bei der Regulierung von KI." (Quelle: eigene Darstellung)
...
> "Die Zukunft der KI ist dynamisch und von schnellen Veränderungen geprägt." (Quelle: eigene Darstellung)
...
> "Der EU AI Act schafft einen klaren und einheitlichen Rechtsrahmen, der die Sicherheit und Transparenz von KI-Systemen gewährleistet." (Quelle: eigene Darstellung)
